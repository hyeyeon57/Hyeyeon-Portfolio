...
export const projects: Project[] = [
  ...
  },
  {
    id: '2',
    title: 'Mom-ro',
    subtitle: '맞춤형 육아정책 플랫폼',
    description: 'UX 설계 및 와이어프레임 제작을 통해 정책 정보 접근성 향상',
    fullDescription: '복잡한 육아 정책 정보를 쉽게 찾을 수 있도록 맞춤형 플랫폼을 기획했습니다. 사용자 중심의 정보 구조 설계로 탐색 효율을 개선했습니다.',
    image: '/projects/momro.jpg',
    tags: ['UX 설계', '와이어프레임', '정보 구조'],
    category: 'planning',
    date: '2024',
    role: 'UX 기획자',
    duration: '2개월',
